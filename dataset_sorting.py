...
class SortFiles:
    ...
    def __init__(self):
        self.basePATH='/data' #the directory with all the downloaded TCGA files
        self.outPATH=os.path.join(self.basePATH,'TCGA_RCC_sorted')

    def sort(self):
        '''goes through each of the directories and sorts all the files into a unique directory if patient is T3/T4'''
    ...
    def dataset_characteristics(self):
        ...
        M1=data['ajcc_pathologic_m'].value_counts()
