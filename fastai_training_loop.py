...
class VisionBinary:
    ...
    def __init__(self):
        ...
        parser.add_argument('--wghtloss')
        args = parser.parse_args()

        print(args)

        self.imagedir='/home/tom/Desktop/revision_analysis3/model_dev_indvPIRADS'
        self.outdir='/home/tom/Desktop/revision_analysis3/output'
